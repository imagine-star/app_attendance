                ...
                if(StrUtil.isNotBlank(result)) {
                    ...
                    if ("5003".equals(cmd)) {
                        ...
                        if ("00".equals(code)) {
                            ...
                            System.out.println("上传人员考勤信息失败！原因是：" + com.jigong.app_attendance.longminggong.HexUtil.hexStringToString(resultContent));
                            map.put(false, com.jigong.app_attendance.longminggong.HexUtil.hexStringToString(resultContent));
                        }
                    }
                    break;
                }
